...
public class FutureService {
  ...
  public interface Iface {
    ...
    public List<Price> predictPrice(String future) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface {
    ...
    public void predictPrice(String future, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public List<Price> predictPrice(String future) throws org.apache.thrift.TException
    {
      send_predictPrice(future);
      return recv_predictPrice();
    }

    public void send_predictPrice(String future) throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void predictPrice(String future, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      predictPrice_call method_call = new predictPrice_call(future, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }
    ...
    public static class predictPrice_call extends org.apache.thrift.async.TAsyncMethodCall {
      private String future;
      public predictPrice_call(String future, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.future = future;
      }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class predictPrice<I extends Iface> extends org.apache.thrift.ProcessFunction<I, predictPrice_args> {
      ...
      public predictPrice_result getResult(I iface, predictPrice_args args) throws org.apache.thrift.TException {
        predictPrice_result result = new predictPrice_result();
        result.success = iface.predictPrice(args.future);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class predictPrice<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, predictPrice_args, List<Price>> {
      ...
      public void start(I iface, predictPrice_args args, org.apache.thrift.async.AsyncMethodCallback<List<Price>> resultHandler) throws TException {
        iface.predictPrice(args.future,resultHandler);
      }
    }
